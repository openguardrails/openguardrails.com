...
(the OpenShell adapter is [`sandbox/openshell.py`](https://github.com/openguardrails/openguardrails-instrumentation-hermes/blob/main/src/openguardrails_instrumentation_hermes/sandbox/openshell.py)).
